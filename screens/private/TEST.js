...
export default function DashboardScreen({ navigation }) {
  ...
  const [chosenDate, setChosenDate] = useState('2012-12-11');
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text
                ...
                {loading ? dashboardData?.leftArrived : '0'}
              </Text>
              <Text
                style={{
                  color: COLORS.white,
            ...
            <TouchableOpacity
              ...
              <Text
                ...
                {loading ? dashboardData?.leftCheckout : '0'}
              </Text>
                ...
                <View
                  ...
                  <View style={styles.blueBox}>
                    <Text
                      ...
                      {loading ? dashboardData?.confirmedQuantity : '0'}
                    </Text>
                  </View>
                  <View>
                    <Text
                ...
                <View
                  ...
                  <View style={styles.blueTextBlock}>
                    <Text
                      ...
                      {loading ? dashboardData?.canceledQuantity : '0'}
                    </Text>
                  </View>
                  <View>
                    <Text
