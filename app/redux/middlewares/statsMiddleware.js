import { getStatsByCategoryDataRequestAction, getStatsByCategoryDataSuccessAction, getStatsByCategoryDataFailureAction, getStatsByYearDataRequestAction, getStatsByYearDataSuccessAction, getStatsByYearDataFailureAction } from '../actions'

async function getStatsByCategoryDataMiddleware(outgoingData) {
    getStatsByCategoryDataRequestAction(chosenStatsDateRange);
    try {
      await getStatisticsByCategoryAPI(outgoingData).then(statisticsByCategoryData => {
