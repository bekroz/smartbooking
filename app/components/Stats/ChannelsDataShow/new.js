<Card containerStyle={styles.card} title="Revenue">
  ...
  {!loading ? (
    ...
    <ActivityIndicator animating={true} color={COLORS.white} marginTop={70} />
  )}
</Card>;
{
  /* SECOND Card */
  ...
  {!loading ? (
    <>
      <View
        ...
        <Text style={{ color: COLORS.grayText }}>{totalSoldNights} ночей</Text>
      </View>
  ...
  {!loading ? (
    <>
      <View
        ...
        <Text style={{ color: COLORS.grayText }}>Всего {totalRevenue} UZS</Text>
      </View>
    ...
    <ActivityIndicator animating={true} color={COLORS.white} marginTop={110} />
  )}
</Card>;
